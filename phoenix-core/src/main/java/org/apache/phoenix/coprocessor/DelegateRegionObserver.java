...
public class DelegateRegionObserver implements RegionObserver {
    ...
    @Override
    public void preGet(ObserverContext<RegionCoprocessorEnvironment> c, Get get,
            List<KeyValue> result) throws IOException {
        delegate.preGet(c, get, result);
    }
    ...
    @Override
    public void postGet(ObserverContext<RegionCoprocessorEnvironment> c, Get get,
            List<KeyValue> result) throws IOException {
        delegate.postGet(c, get, result);
    }
